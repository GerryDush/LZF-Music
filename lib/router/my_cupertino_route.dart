...
final Animatable<Offset> _kMiddleLeftTween = Tween<Offset>(
  begin: Offset.zero,
  end: Offset(CommonUtils.select(PlatformUtils.isMobile, t: -1.0 / 3.0, f: -1), 0.0),
);
...
class _PageBasedCupertinoPageRoute<T> extends PageRoute<T>
  ...
  _PageBasedCupertinoPageRoute(
      {required CupertinoPage<T> page, super.allowSnapshotting = true})
      : super(settings: page) {
    assert(opaque);
  }
    ...
    return SlideTransition(
      ...
      child: SlideTransition(
        ...
        child: DecoratedBoxTransition(
            decoration: _primaryShadowAnimation, child: widget.child),
      ),
    );
  }
}
...
class _CupertinoFullscreenDialogTransitionState
  ...
  Widget build(BuildContext context) {
    ...
    return SlideTransition(
      ...
      transformHitTests: false,
      child: SlideTransition(
          position: _primaryPositionAnimation, child: widget.child),
    );
  }
}
...
class _CupertinoEdgeShadowDecoration extends Decoration {
  ...
  static DecorationTween kTween = DecorationTween(
    begin: const _CupertinoEdgeShadowDecoration._(), // No decoration initially.
      ...
      <Color>[Color(0x04000000), Colors.transparent],
    ),
  );
  ...
  Widget buildTransitions(
    ...
    return Align(
      ...
      child: FractionalTranslation(
          translation: _offsetTween.evaluate(animation), child: child),
    );
  }
